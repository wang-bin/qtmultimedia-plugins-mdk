...
QTDIR_build {
    ...
    greaterThan(QT_MAJOR_VERSION, 5) {
        ...
        PLUGIN_CLASS_NAME = MDKMediaPlugin
    } else {
    ...
    greaterThan(QT_MAJOR_VERSION, 5) {
        target.path = $$[QT_INSTALL_PLUGINS]/multimedia
    } else {
...
greaterThan(QT_MAJOR_VERSION, 5) {
    # Qt 6.4+: new multimedia plugin framework
    ...
    # Qt 5: legacy mediaservice plugin framework
    qtHaveModule(widgets): QT += multimediawidgets
